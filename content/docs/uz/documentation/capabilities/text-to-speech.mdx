...
- **Oqim Uchastkasi**: WebSocket orqali audio'ni real vaqt rejimida yetkazib beradi, bu past kechikishli ilovalar uchun mos. U `ws://oyqiz.airi.uz/stream` manzilida ulanish mumkin (API havolasida [qanday ishlatishni ko'ring](../../api/tts/stream)).
