...
- **Streaming Endpoint**: Delivers audio in real-time via WebSocket, suited for low-latency applications. Connect at `ws://oyqiz.airi.uz/stream` (see [how to use](../../api/tts/stream) in the API Reference).
