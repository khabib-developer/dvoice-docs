...
The STT functionality is accessible via a POST request to the `https://oyqiz.airi.uz/api/v2/stt` endpoint. This endpoint processes audio input and returns the transcribed text along with performance metrics.
